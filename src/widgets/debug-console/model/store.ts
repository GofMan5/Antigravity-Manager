...
export const useDebugConsole = create<DebugConsoleState>((set, get) => ({
  ...
  enable: async () => {
    try {
      ...
      console.error('[DebugConsole] Failed to enable:', error);
    }
  },
  ...
  disable: async () => {
    try {
      ...
      console.error('[DebugConsole] Failed to disable:', error);
    }
  },
  ...
  loadLogs: async () => {
    try {
      ...
      console.error('[DebugConsole] Failed to load logs:', error);
    }
  },
  ...
  clearLogs: async () => {
    try {
      ...
      console.error('[DebugConsole] Failed to clear logs:', error);
    }
  },
  ...
  startListening: async () => {
    ...
    try {
      ...
      console.error('[DebugConsole] Failed to start listening:', error);
    }
  },
  ...
  checkEnabled: async () => {
    try {
      ...
      console.error('[DebugConsole] Failed to check status:', error);
    }
  },
}));
